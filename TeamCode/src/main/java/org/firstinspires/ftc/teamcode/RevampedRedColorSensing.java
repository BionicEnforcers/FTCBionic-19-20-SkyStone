    ...
    public void runOpMode() {
        ...
        while(opModeIsActive())
        {
            ...
            //Use the Right Color Sensor to Scan for a SkyStone
            //Checks if the Object is a Stone
            if(robot.RightColorSensor.readUnsignedByte((ModernRoboticsI2cColorSensor.Register.COLOR_NUMBER)) == 8 || robot.RightColorSensor.readUnsignedByte((ModernRoboticsI2cColorSensor.Register.COLOR_NUMBER)) == 9)
            {
                ...
                if(robot.RightColorSensor.readUnsignedByte((ModernRoboticsI2cColorSensor.Register.COLOR_NUMBER)) == 8 || robot.RightColorSensor.readUnsignedByte((ModernRoboticsI2cColorSensor.Register.COLOR_NUMBER)) == 9)
                {
                    ...
                    //After getting the Skystone the Robot delivers is to the building zone
                        ...
                        //Turns Right to Face the Building Zone
                        ...
                        //Turns Left so that the robot can face the SkyStone
                        ...
                        StrafLeftDistance(.3,5);
                        //Turns Right to face the robot towards the building zone
                        TurnRightDistance(.3,22);
